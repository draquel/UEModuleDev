...
public:
	...
	static FMeshData RectMesh(FVector position, FVector size, FVector2D segments, float UVScale, FNoiseSettings* NoiseSettings, int heightMultiplier);
	static FMeshData RectMesh(FNoiseMap2d* NoiseMap, FVector position, FVector size, int stepSize, float UVScale, int heightMultiplier);
	static FMeshData RectMesh(UTexture2D* Texture, FVector position, FVector size, int StepSize, int TextureStepSize, float UVScale, int heightMultiplier);

	static FMeshData QuadTreeMesh(UQuadTree* QTree, float UVScale, int depthFilter);
	static FMeshData QuadTreeMesh(UQuadTree* QTree, float UVScale, int depthFilter, FNoiseSettings* NoiseSettings, int heightMultiplier);
