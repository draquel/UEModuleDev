...
struct COMPUTESHADERS_API FMySimpleComputeShaderDispatchParams
{
	int X;
	int Y;
	int Z;
...
class COMPUTESHADERS_API FMySimpleComputeShaderInterface {
public:
...
class COMPUTESHADERS_API UMySimpleComputeShaderLibrary_AsyncExecution : public UBlueprintAsyncActionBase
{
	GENERATED_BODY()
